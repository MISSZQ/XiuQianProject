...
<form method="post" action="" id="listform">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            <tr>
                <th width="10%" style="text-align:left; padding-left:20px;">用户ID</th>
                <th width="15%" style="text-align:left; padding-left:20px;">用户</th>
                <th width="10%">关注用户ID</th>
                <th width="15%">关注用户</th>
            </tr>
            ...
            <volist name="list" id="vo">
                <tr>
                   <td>${attention.userId.userId}</td>
                    <td>${attention.userId.userName}</td>
                    <td>${attention.attentionuserId.userId}</td>
                    <td>${attention.attentionuserId.userName}</td>

      ...
      <volist name="list" id="vo">
        <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" />
              ${activity.activityId}</td>
          <%--<td><input type="text" name="sort[1]" value="1" style="width:50px; text-align:center; border:1px solid #ddd; padding:7px 0;" /></td>--%>
          <td width="10%"><img src="${activity.activityImageUrl}" alt="" width="70" height="50" /></td>
          <td>${activity.activityTitle}</td>
          <td><font color="#00CC99">${activity.activityStartUser.userName}</font></td>
          <td>${activity.activityAttendNum}</td>
          <td>${activity.activityIntroduce}</td>
          <td>${activity.activityStartTime}</td>
          <td>${activity.activityEndTime}</td>
          <td>${activity.activityUserNumber}</td>
          <td>${activity.punishId.punishName}</td>
